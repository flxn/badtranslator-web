<template>
  <div id="main">
    <div class="container has-text-centered">
      ...
      <h2 class="subtitle">
        A game of <em>Chinese Whispers</em> but with online translators.
        <br />And they're worse at it than you.
      </h2>
      ...
      <div class="columns">
        <div class="column">
              ...
              <div class="control">
                <div class="select">
                  ...
                  >
                    ...
                    <option value="9">9 rounds of translation</option>
                    <option value="10">10 rounds of translation</option>
                  </select>
                </div>
              </div>
            </div>
            ...
            <div class="field">
              <div class="control">
                <textarea
                  name="inputText"
                  id="inputText"
                  :class="{'textarea': true, 'is-danger': errorNoText || inputText.length > 2000}"
                  cols="30"
                  rows="6"
                  placeholder="Input any text"
                  v-model="inputText"
                ></textarea>
                <span class="counter">{{inputText.length}}/2000</span>
              </div>
            </div>
          ...
          <div id="translation-steps">
            <div class="step columns" v-for="step in steps" :key="`${step.from}-${step.to}`">
          ...
          <div id="result">
            ...
            <ShareButtons v-if="outputText" style="margin-top: 30px" callToAction="Share this translation" title="This is what happens when you translate through random languages" :text="outputText" />
            <button
            ...
            <p v-if="outputText" style="margin-top: 30px">Too crazy? Try lowering the rounds of translation.<br/>Not crazy enough? Try increasing the number of rounds.</p>
          </div>
          ...
          <div class="content" style="width: 960px; margin: 0 auto;">
            <p>
            This site is based on the <em>telephone</em> game, also called <em>chinese whispers</em>, just with online translation services instead of real people.
            ...
            <p>Here is the first paragraph of the <a href="https://en.wikipedia.org/wiki/Chinese_whispers" rel="noopener" target="_blank">Wikipedia article for "Chinese Whispers"</a> translated through 6 different languages and back to english:</p>
            <blockquote style="text-align: left">
              ...
              <br/>
              This game is often a party game or a game for children. It is often a metaphor for a growing error, especially rumours or rumours, or at all, a lack of reliability of human memory or oral tradition.
            </blockquote>
            <p>
              As a translation provider I'm currently using the Microsoft Azure Translator Text API
            </p>
          </div>
        </div>
      </div>
    ...
    <div :class="{'modal': true, 'is-active': showDonationModal}">
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          <p>
            I hope you enjoy this app and had a few good laughs 😊
          ...
          <a
            ...
            target="_blank"
            style="margin: 0 5px;">
            <span class="icon"><i class="fab fa-paypal"></i></span> <span>Donate on PayPal</span>
          </a>
          <a
            ...
            target="_blank"
            style="margin: 0 5px;">
            <span class="icon"><img src="../assets/cup-border.png" width="24" loading="lazy" alt="Support Me on Ko-Fi" /></span> <span>Donate on Ko-Fi</span>
          </a>
          <a
            ...
            target="_blank"
            style="margin: 0 5px;">
            <span class="icon"><i class="fab fa-patreon"></i></span> <span>Donate on Patreon</span>
          </a>
          <p>
        ...
        <footer class="modal-card-foot">
          <button class="button is-success" @click="setDonationModalDisabled()">I already did 🥰</button>
          <button class="button is-warning" @click="setDonationModalPostponed()">I'll think about it 🙂</button>
          <button class="button is-danger" @click="setDonationModalDisabled()">I certainly won't 🙁</button>
        </footer>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async startTranslation() {
      ...
      if (this.inputText.length > 2000) {
        this.errorMessages.push(
          "Your text is too long. Maximum is 1000 characters."
        );
        return;
      }
      ...
      for (let i = 0; i < chain.length; i++) {
        const code = chain[i];
        const toName = this.availableLanguages[code].name;
        const fromName = this.availableLanguages[lastLang].name;
        try {
      ...
      const toName = this.availableLanguages[inputLang].name;
      const fromName = this.availableLanguages[lastLang].name;
      let outTxt = "";
      try {
    ...
    increaseCount() {
      this.translationCount = Number(window.localStorage.getItem("translationCount")) || 0;
      this.translationCount += 1;
      window.localStorage.setItem("translationCount", this.translationCount);
      const modalInterval = window.localStorage.getItem("donationModalInterval") || 10;
      const modalDisabled = window.localStorage.getItem("donationModalDisabled") === "true";
